...
teams = pkl.load(open('/workspaces/ipl_predictor/ipl_predictor/team.pkl','rb'))
cities = pkl.load(open('/workspaces/ipl_predictor/ipl_predictor/city.pkl','rb'))
model = pkl.load(open('/workspaces/ipl_predictor/ipl_predictor/model.pkl','rb'))
